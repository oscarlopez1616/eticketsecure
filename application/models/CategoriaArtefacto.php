...
class Application_Model_CategoriaArtefacto
{
    private $_id;
    private $_publicado; 
    private $_id_parent; 
    ...
    private $_sef_arr;
    private $_MetaTag;
    private $_InterfaceCategoriaArtefactoEticketSecure;
    ...
    public function __construct($id=NULL,$publicado=null,$id_parent=null,$nombre_arr=NULL,$descripcion_arr=NULL,
        ...
        $this->_InterfaceCategoriaArtefactoEticketSecure = new Application_Model_InterfaceCategoriaArtefactoEticketSecure();
        $this->_id=(integer)$id; 
    ...
    public function load($id){
        if(!isset($id))    throw new Exception('loadCategoriaAtefacto');
        
        $idioma_arr = $reg_webservice=Zend_Registry::get('idioma');
        $num_idiomas = $idioma_arr["count"];   
        $this->_id=$id;
        $data=$this->_InterfaceCategoriaArtefactoEticketSecure->getCategoriaArtefactoById($this->_id);
    ...
    */  
    ...
    public function write(){
        ...
        $data=$this->_InterfaceCategoriaArtefactoEticketSecure->setCategoriaArtefactoById($id, $representacion_xml, $publicado, $altura, $id_parent);
        return $data; 
    } 
    ...
    public function add(){
        ...
        $publicado=$this->_publicado;
        $id_parent=$this->_id_parent;
        $data=$this->_InterfaceCategoriaArtefactoEticketSecure->addCategoriaArtefacto($representacion_xml, $publicado,$id_parent);
        $this->_id=$data;
        return $data; 
    } 
    ...
    public function delete(){
        $id=$this->_id;
        $data=$this->_InterfaceCategoriaArtefactoEticketSecure->deleteCategoriaArtefacto($id);
        return $data;     
    } 
}
